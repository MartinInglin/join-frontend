...
let switchDropDownCategoryAddTask = false;
let newTask;
...
function searchContactToAssign() {
  ...
  let matchingContacts = contacts.filter(
    (contact) => contact.firstname.toLowerCase().includes(input) || contact.lastname.toLowerCase().includes(input)
  );
...
function toggleDropDownCategory() {
  switchDropDownCategoryAddTask = !switchDropDownCategoryAddTask;
  if (switchDropDownCategoryAddTask) {
...
function showDropDownCategory() {
  switchDropDownCategoryAddTask = true;
...
function hideDropDownCategoryDelay() {
  setTimeout(function () {
    switchDropDownCategoryAddTask = false;
